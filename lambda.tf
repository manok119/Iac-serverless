...
resource "aws_lambda_permission" "sale_api" {
  ...
  source_arn = "arn:aws:execute-api:ap-northeast-2:694280818671:${aws_api_gateway_rest_api.sale_api.id}/*/${aws_api_gateway_method.sale_api.http_method}${aws_api_gateway_resource.sale_api.path}"
}
